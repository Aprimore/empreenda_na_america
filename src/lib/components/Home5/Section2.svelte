...
<section class="w-full max-sm:p-2 py-10" data-sveltekit-preload-data="viewport">
	<div class="lg:max-w-[90rem] mx-auto max-sm:p-2">
		...
		>
			<!----------------------- EBOOK_STARTUP ------------------------------------->
			<div
				class="bg-gradient-to-b from-teal-400 to-rose-200 rounded-2xl max-md:flex lg:flex lg:flex-col max-md:flex-col max-md:text-center p-3"
			>
			...
			<div
				class="bg-gradient-to-b from-teal-400 to-rose-200
 rounded-2xl max-md:flex lg:flex lg:flex-col max-md:flex-col max-md:text-center p-3"
			...
			<div
				class="bg-gradient-to-b from-teal-400 to-rose-200 rounded-2xl row-end-3 max-md:flex lg:flex lg:flex-col max-md:flex-col max-md:text-center p-3"
			>
				<p class="text-2xl text-center p-3">{$t('EBOOK_EXTRACT')}</p>
				<img
					class="bg-gradient-to-b from-teal-400 to-rose-200 rounded-2xl object-contain aspect-[4/3] max-h-72 max-md:maxh-60 mx-auto transition-transform duration-300 ease-in-out transform hover:scale-105"
