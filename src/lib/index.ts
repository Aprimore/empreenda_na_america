...
export { default as EBOOK_IADVOCATICIA_webp } from './assets/images/ebooks/EBOOK_IADVOCATICIA.webp';
export { default as EBOOK_MARKET_webp } from './assets/images/ebooks/EBOOK_MARKET.webp';
// extract2
export { default as EBOOK_IADVOCATICIA2_webp } from './assets/images/ebooks/EBOOK_IADVOCATICIA2.webp';
export { default as EBOOK_KID_MONEY_webp } from './assets/images/ebooks/EBOOK_KID_MONEY.webp';
export { default as EBOOK_PLAN_webp } from './assets/images/ebooks/EBOOK_PLAN.webp';
...
export { default as hotmart_svg } from './assets/svg/hotmart.svg';
